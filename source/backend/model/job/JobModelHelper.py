...
class JobModelHelper:
    ...
    # helper method to create an id encrypted for the AppliedJob class
    def CreateAppliedJobID(userId: str, jobId: str) -> str:
        return hashlib.sha256(str.encode(userId.join(jobId))).hexdigest()